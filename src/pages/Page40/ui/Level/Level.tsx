...
export const Level = (props: LevelProps) => {
  ...
  return (
    <>
      ...
      {levelBlocks}
      <BlockEnd geometry={boxGeometry} material={floor1Material} position={[0, 0, -blockSize * (lenght + 1)]} />
      <Bounds length={lenght + 2} size={blockSize} geometry={boxGeometry} material={wallMaterial} />
    </>
  );
};
